# #1 yolo-training-pipeline: map50_95_median = pending
...
The benchmark is the proof. map50_95_median = pending.  The result is stored in `benchmarks/results/summary.json` and can be reproduced from the Docker/local path.
