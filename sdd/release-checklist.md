...
- [ ] Docker build resolves and imports the pinned dependencies.
- [ ] Lint and at least 90% focused pure coverage pass.
- [ ] Three full training and inference runs pass on one image.
- [ ] Summary JSON validates and README opens with measured mAP and latency.
- [ ] Reuse review is resolved and published kit commit is synchronized.
- [ ] Git status contains only intentional source/evidence and no runtime data.
